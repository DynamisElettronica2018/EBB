...
#line 13 "C:/Users/nicol/Documents/git_codes/EBB/EBB_DPX.c"
...
#line 155 "c:/users/nicol/documents/git_codes/ebb/modules/motor.c"
 ...
 buzzer_state =  1 ;
 if(brake_pressure_front <  430  && current_reading_motor <  (1.831f)  *  300 )
 {
 buzzer_state =  0 ;
 ebb_current_state = EBB_START;
 }
...
void main() {
 ...
 if ((ebb_target_pos != ebb_current_pos) && ebb_target_pos >=  5  && ebb_target_pos <=  11 )
 {
