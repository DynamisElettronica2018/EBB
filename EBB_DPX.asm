...
;motor.c,7 :: 		switch(DIRECTION_REGISTER){
	GOTO	L_counter_quarter_turn_match83
;motor.c,8 :: 		case 0:  //negative direction
L_counter_quarter_turn_match85:
;motor.c,9 :: 		motor_current_position--;
	MOV	#1, W1
	MOV	#lo_addr(_motor_current_position), W0
	SUBR	W1, [W0], [W0]
;motor.c,10 :: 		break;
	GOTO	L_counter_quarter_turn_match84
;motor.c,11 :: 		case 1:  //positive direction
L_counter_quarter_turn_match86:
;motor.c,12 :: 		motor_current_position++;
	MOV	#1, W1
	MOV	#lo_addr(_motor_current_position), W0
	ADD	W1, [W0], [W0]
;motor.c,13 :: 		break;
...
;motor.c,17 :: 		if (motor_current_position == motor_target_position)                        //Check for target reached
...
;motor.c,19 :: 		brake_counter = 0;                                                      //Reset the counter for braking period lenght
	MOV	#lo_addr(_brake_counter), W1
	CLR	W0
	MOV.B	W0, [W1]
;motor.c,20 :: 		ebb_current_state = EBB_BRAKING;                                        //Set the current state
	MOV	#lo_addr(_ebb_current_state), W1
	MOV.B	#3, W0
	MOV.B	W0, [W1]
;motor.c,21 :: 		}
L_counter_quarter_turn_match88:
;motor.c,22 :: 		IFS2bits.QEIIF = 0;                                                         //Reset Interrupt Flag
	BCLR	IFS2bits, #8
;motor.c,23 :: 		}
...
;motor.c,27 :: 		void EBB_control()
;motor.c,29 :: 		switch(ebb_current_state)           //State machine
	PUSH	W10
	PUSH	W11
	PUSH	W12
	GOTO	L_EBB_control89
;motor.c,31 :: 		case EBB_OFF:                      //Off state
L_EBB_control91:
;motor.c,32 :: 		if(is_requested_movement)       //Check if the EBB is requested to move in a different position
	MOV	#lo_addr(_is_requested_movement), W0
	CP0.B	[W0]
	BRA NZ	L__EBB_control275
	GOTO	L_EBB_control92
L__EBB_control275:
;motor.c,34 :: 		switch(ebb_target_pos)  //Obtain the requested position in quarter of turns (maybe to be improved!!)
	GOTO	L_EBB_control93
;motor.c,36 :: 		case 0:
L_EBB_control95:
;motor.c,37 :: 		motor_target_position = POSITION_0;
	CLR	W0
...
;motor.c,39 :: 		case 1:
L_EBB_control96:
;motor.c,40 :: 		motor_target_position = POSITION_1;
	MOV	#2, W0
	MOV	W0, _motor_target_position
;motor.c,41 :: 		break;
	GOTO	L_EBB_control94
;motor.c,42 :: 		case 2:
L_EBB_control97:
;motor.c,43 :: 		motor_target_position = POSITION_2;
	MOV	#4, W0
	MOV	W0, _motor_target_position
;motor.c,44 :: 		break;
	GOTO	L_EBB_control94
;motor.c,45 :: 		case 3:
L_EBB_control98:
;motor.c,46 :: 		motor_target_position = POSITION_3;
	MOV	#6, W0
	MOV	W0, _motor_target_position
;motor.c,47 :: 		break;
	GOTO	L_EBB_control94
;motor.c,48 :: 		case 4:
L_EBB_control99:
;motor.c,49 :: 		motor_target_position = POSITION_4;
	MOV	#8, W0
	MOV	W0, _motor_target_position
;motor.c,50 :: 		break;
	GOTO	L_EBB_control94
;motor.c,51 :: 		case 5:
L_EBB_control100:
;motor.c,52 :: 		motor_target_position = POSITION_5;
	MOV	#10, W0
	MOV	W0, _motor_target_position
;motor.c,53 :: 		break;
	GOTO	L_EBB_control94
;motor.c,54 :: 		case 6:
L_EBB_control101:
;motor.c,55 :: 		motor_target_position = POSITION_6;
	MOV	#12, W0
	MOV	W0, _motor_target_position
;motor.c,56 :: 		break;
	GOTO	L_EBB_control94
;motor.c,57 :: 		case 7:
L_EBB_control102:
;motor.c,58 :: 		motor_target_position = POSITION_7;
	MOV	#14, W0
	MOV	W0, _motor_target_position
;motor.c,59 :: 		break;
	GOTO	L_EBB_control94
;motor.c,60 :: 		case 8:
L_EBB_control103:
;motor.c,61 :: 		motor_target_position = POSITION_8;
	MOV	#16, W0
	MOV	W0, _motor_target_position
;motor.c,62 :: 		break;
	GOTO	L_EBB_control94
;motor.c,63 :: 		case 9:
L_EBB_control104:
;motor.c,64 :: 		motor_target_position = POSITION_9;
	MOV	#18, W0
	MOV	W0, _motor_target_position
;motor.c,65 :: 		break;
	GOTO	L_EBB_control94
;motor.c,66 :: 		case 10:
L_EBB_control105:
;motor.c,67 :: 		motor_target_position = POSITION_10;
	MOV	#20, W0
	MOV	W0, _motor_target_position
;motor.c,68 :: 		break;
	GOTO	L_EBB_control94
;motor.c,69 :: 		case 11:
L_EBB_control106:
;motor.c,70 :: 		motor_target_position = POSITION_11;
	MOV	#22, W0
	MOV	W0, _motor_target_position
;motor.c,71 :: 		break;
	GOTO	L_EBB_control94
;motor.c,72 :: 		case 12:
L_EBB_control107:
;motor.c,73 :: 		motor_target_position = POSITION_12;
	MOV	#24, W0
	MOV	W0, _motor_target_position
;motor.c,74 :: 		break;
	GOTO	L_EBB_control94
;motor.c,75 :: 		case 13:
L_EBB_control108:
;motor.c,76 :: 		motor_target_position = POSITION_13;
	MOV	#26, W0
	MOV	W0, _motor_target_position
;motor.c,77 :: 		break;
	GOTO	L_EBB_control94
;motor.c,78 :: 		case 14:
L_EBB_control109:
;motor.c,79 :: 		motor_target_position = POSITION_14;
	MOV	#28, W0
	MOV	W0, _motor_target_position
;motor.c,80 :: 		break;
	GOTO	L_EBB_control94
;motor.c,81 :: 		case 15:
L_EBB_control110:
;motor.c,82 :: 		motor_target_position = POSITION_15;
	MOV	#30, W0
	MOV	W0, _motor_target_position
;motor.c,83 :: 		break;
	GOTO	L_EBB_control94
;motor.c,84 :: 		case 16:
L_EBB_control111:
;motor.c,85 :: 		motor_target_position = POSITION_16;
	MOV	#32, W0
	MOV	W0, _motor_target_position
;motor.c,86 :: 		break;
	GOTO	L_EBB_control94
...
L__EBB_control292:
L_EBB_control94:
;motor.c,88 :: 		ebb_current_state = EBB_START;          //Set the correct new ebb state (start moving)
	MOV	#lo_addr(_ebb_current_state), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;motor.c,89 :: 		is_requested_movement = OFF;            //Switch off flag
	MOV	#lo_addr(_is_requested_movement), W1
	CLR	W0
	MOV.B	W0, [W1]
;motor.c,90 :: 		}else if(is_requested_calibration)          //Check if ebb is requested to enter calibration mode
...
L__EBB_control293:
;motor.c,92 :: 		ebb_current_state = EBB_CENTRAL_CALIBRATION;        //Set the correct new ebb state (calibration)
	MOV	#lo_addr(_ebb_current_state), W1
	MOV.B	#5, W0
	MOV.B	W0, [W1]
;motor.c,93 :: 		is_requested_calibration = OFF;                     //Switch off flag
...
;motor.c,96 :: 		case EBB_START:                                             //Start a movement mode
L_EBB_control114:
;motor.c,97 :: 		if(motor_target_position > motor_current_position)      //Check if is necessary to screw or unscrew the balance bar
...
L__EBB_control294:
;motor.c,99 :: 		FORWARD = ON;                                         //Unscrew
	BSET	LATE4_bit, BitPos(LATE4_bit+0)
;motor.c,100 :: 		REVERSE = OFF;
	BCLR	LATE3_bit, BitPos(LATE3_bit+0)
;motor.c,101 :: 		}else if (motor_target_position < motor_current_position)
...
L__EBB_control295:
;motor.c,103 :: 		REVERSE = ON;                                       //Screw
	BSET	LATE3_bit, BitPos(LATE3_bit+0)
;motor.c,104 :: 		FORWARD = OFF;
	BCLR	LATE4_bit, BitPos(LATE4_bit+0)
;motor.c,105 :: 		}
L_EBB_control117:
L_EBB_control116:
;motor.c,106 :: 		ENABLE = ON;                                            //Turn on H-bridge
	BSET	LATE2_bit, BitPos(LATE2_bit+0)
;motor.c,107 :: 		PDC1 = PWM_SATURATION;                                  //Put the pwm at maximum (disabled pwm control)
	MOV	#4000, W0
	MOV	WREG, PDC1
;motor.c,109 :: 		ebb_current_state = EBB_MOVING;                         //Update State
	MOV	#lo_addr(_ebb_current_state), W1
	MOV.B	#2, W0
	MOV.B	W0, [W1]
;motor.c,110 :: 		break;
	GOTO	L_EBB_control90
;motor.c,111 :: 		case EBB_MOVING:                               //EBB is trying to reach the requested position
L_EBB_control118:
;motor.c,112 :: 		blink_counter++;
	MOV.B	#1, W1
	MOV	#lo_addr(_blink_counter), W0
	ADD.B	W1, [W0], [W0]
;motor.c,113 :: 		if(blink_counter >= 20)
	MOV	#lo_addr(_blink_counter), W0
	MOV.B	[W0], W0
	CP.B	W0, #20
...
L__EBB_control296:
;motor.c,115 :: 		LED_G = ~LED_G;                        //Signal that the motor is turning with a blincking green led
	BTG	LATD1_bit, BitPos(LATD1_bit+0)
;motor.c,116 :: 		blink_counter = 0;
...
;motor.c,118 :: 		break;
	GOTO	L_EBB_control90
;motor.c,119 :: 		case EBB_BRAKING:                              //EBB has reached the position and is now bhraking the motor shorting it
L_EBB_control120:
;motor.c,120 :: 		LED_G = OFF;
	BCLR	LATD1_bit, BitPos(LATD1_bit+0)
;motor.c,121 :: 		LED_B = ON;                             //Turn on Blue led to signal motor Braking mode
	BSET	LATD3_bit, BitPos(LATD3_bit+0)
;motor.c,122 :: 		ENABLE = ON;
	BSET	LATE2_bit, BitPos(LATE2_bit+0)
;motor.c,123 :: 		REVERSE = OFF;                          //Shorts the motor terminals
	BCLR	LATE3_bit, BitPos(LATE3_bit+0)
;motor.c,124 :: 		FORWARD = OFF;
	BCLR	LATE4_bit, BitPos(LATE4_bit+0)
;motor.c,125 :: 		brake_counter++;
	MOV.B	#1, W1
	MOV	#lo_addr(_brake_counter), W0
	ADD.B	W1, [W0], [W0]
;motor.c,126 :: 		if(brake_counter >= BRAKE_TIME_LENGHT)          //check if the Braking period has passed
	MOV	#lo_addr(_brake_counter), W0
	MOV.B	[W0], W1
	MOV.B	#100, W0
	CP.B	W1, W0
...
L__EBB_control297:
;motor.c,128 :: 		brake_counter = 0;                          //reset the brake counter
	MOV	#lo_addr(_brake_counter), W1
	CLR	W0
	MOV.B	W0, [W1]
;motor.c,129 :: 		ebb_current_state = EBB_POSITION_REACHED;
	MOV	#lo_addr(_ebb_current_state), W1
	MOV.B	#4, W0
	MOV.B	W0, [W1]
;motor.c,130 :: 		}
...
;motor.c,131 :: 		break;
	GOTO	L_EBB_control90
;motor.c,132 :: 		case EBB_POSITION_REACHED:                                                  //The ebb has correctly reached th requested position
L_EBB_control122:
;motor.c,133 :: 		LED_B = OFF;
	BCLR	LATD3_bit, BitPos(LATD3_bit+0)
;motor.c,134 :: 		ENABLE = OFF;
	BCLR	LATE2_bit, BitPos(LATE2_bit+0)
;motor.c,135 :: 		REVERSE = OFF;                                                          //Turn off the motor
	BCLR	LATE3_bit, BitPos(LATE3_bit+0)
;motor.c,136 :: 		FORWARD = OFF;
	BCLR	LATE4_bit, BitPos(LATE4_bit+0)
;motor.c,137 :: 		ebb_current_pos = ebb_target_pos;                                       //Update ebb cuurent position with the reached one (for robustness)
	MOV	_ebb_target_pos, W0
	MOV	W0, _ebb_current_pos
;motor.c,138 :: 		motor_current_position = motor_target_position;                         //Update motor position with the reached one (for robustness)
	MOV	_motor_target_position, W0
	MOV	W0, _motor_current_position
;motor.c,139 :: 		EEPROM_WRITE(ADDR_LAST_POSCNT, POSCNT);
	MOV	POSCNT, W12
	MOV	#64928, W10
	MOV	#127, W11
	CALL	_EEPROM_Write
;motor.c,140 :: 		while(WR_bit);                                                             //Update EEPROM data
L_EBB_control123:
	BTSS	WR_bit, BitPos(WR_bit+0)
	GOTO	L_EBB_control124
	GOTO	L_EBB_control123
L_EBB_control124:
;motor.c,141 :: 		EEPROM_WRITE(ADDR_LAST_NUMBER_QUARTER_TURNS, motor_current_position);
	MOV	_motor_current_position, W12
	MOV	#64944, W10
	MOV	#127, W11
	CALL	_EEPROM_Write
;motor.c,142 :: 		while(WR_bit);
L_EBB_control125:
	BTSS	WR_bit, BitPos(WR_bit+0)
	GOTO	L_EBB_control126
	GOTO	L_EBB_control125
L_EBB_control126:
;motor.c,143 :: 		EEPROM_WRITE(ADDR_LAST_MAPPED_POSITION, ebb_current_pos);
	MOV	_ebb_current_pos, W12
	MOV	#64960, W10
	MOV	#127, W11
	CALL	_EEPROM_Write
;motor.c,144 :: 		while(WR_bit);
L_EBB_control127:
	BTSS	WR_bit, BitPos(WR_bit+0)
	GOTO	L_EBB_control128
	GOTO	L_EBB_control127
L_EBB_control128:
;motor.c,145 :: 		ebb_current_state = OFF;                                               //Going back to OFF state
	MOV	#lo_addr(_ebb_current_state), W1
	CLR	W0
	MOV.B	W0, [W1]
;motor.c,146 :: 		break;
	GOTO	L_EBB_control90
;motor.c,147 :: 		case EBB_DRIVER_BRAKING:                            //Driver is braking during a requested movement
L_EBB_control129:
;motor.c,148 :: 		sound = ON;                                     //Turn on buzzer for debugging
	MOV	#1, W0
	MOV	W0, _sound
;motor.c,149 :: 		if(brake_pressure_front < BRAKE_PRESSURE_TRIGGER)           //Checking brake pressures for the end of the braking action
...
L__EBB_control298:
;motor.c,151 :: 		sound = OFF;
	CLR	W0
	MOV	W0, _sound
;motor.c,152 :: 		ebb_current_state = EBB_START;              //Return to start mode to complete the movement
	MOV	#lo_addr(_ebb_current_state), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;motor.c,153 :: 		}
...
;initialization.c,25 :: 		TRISEbits.TRISE4 = 0;                           //Forward output
	BCLR	TRISEbits, #4
;initialization.c,26 :: 		TRISEbits.TRISE2 = 0;                           //Reverse output
	BCLR	TRISEbits, #2
;initialization.c,27 :: 		TRISEbits.TRISE1 = 0;                           //Enable output
	BCLR	TRISEbits, #1
...
;initialization.c,31 :: 		LED_G = 0;
	BCLR	LATD1_bit, BitPos(LATD1_bit+0)
;initialization.c,33 :: 		QEICON = 0b0000010100000010;                    //Set Quadrature Encoder
	MOV	#1282, W0
	MOV	WREG, QEICON
...
;initialization.c,63 :: 		ebb_current_state = EBB_OFF;
	...
	CLR	W0
	MOV.B	W0, [W1]
;initialization.c,66 :: 		setTimer(TIMER1_DEVICE,0.01);                                         //Interrupt every 1mS
	MOV	#55050, W11
	MOV	#15395, W12
	MOV.B	#1, W10
	CALL	_setTimer
;initialization.c,67 :: 		setTimer(TIMER2_DEVICE,0.001 * CONTROL_ROUTINE_REFRESH);              //Interrupt every CONTROL_ROUTINE_REFRESH mS
	MOV	#55051, W11
	MOV	#15523, W12
	MOV.B	#2, W10
	CALL	_setTimer
...
;initialization.c,74 :: 		delay_ms(800);
	MOV	#82, W8
	MOV	#24943, W7
L_EBB_Init140:
	DEC	W7
...
;EBB_DPX.c,91 :: 		onTimer1Interrupt {
;EBB_DPX.c,92 :: 		timer1_counter ++;
	MOV	#1, W1
	MOV	#lo_addr(_timer1_counter), W0
	ADD	W1, [W0], [W0]
;EBB_DPX.c,93 :: 		if (timer1_counter == 100){
	MOV	#100, W1
	MOV	#lo_addr(_timer1_counter), W0
	CP	W1, [W0]
	BRA Z	L__timer1_interrupt308
	GOTO	L_timer1_interrupt142
L__timer1_interrupt308:
;EBB_DPX.c,94 :: 		ebb_current_state = EBB_OFF;
	MOV	#lo_addr(_ebb_current_state), W1
	CLR	W0
	MOV.B	W0, [W1]
;EBB_DPX.c,95 :: 		ebb_target_pos = 7;
	MOV	#7, W0
	MOV	W0, _ebb_target_pos
;EBB_DPX.c,96 :: 		}
L_timer1_interrupt142:
;EBB_DPX.c,97 :: 		if (timer1_counter == 250){
	MOV	#250, W1
	MOV	#lo_addr(_timer1_counter), W0
	CP	W1, [W0]
...
;EBB_DPX.c,98 :: 		ebb_current_state = EBB_OFF;
	MOV	#lo_addr(_ebb_current_state), W1
	CLR	W0
	MOV.B	W0, [W1]
;EBB_DPX.c,99 :: 		ebb_target_pos = 6;
	MOV	#6, W0
	MOV	W0, _ebb_target_pos
;EBB_DPX.c,100 :: 		}
L_timer1_interrupt143:
;EBB_DPX.c,101 :: 		if (timer1_counter == 400){
...
;EBB_DPX.c,102 :: 		ebb_current_state = EBB_OFF;
	MOV	#lo_addr(_ebb_current_state), W1
	CLR	W0
	MOV.B	W0, [W1]
;EBB_DPX.c,103 :: 		ebb_target_pos = 5;
	MOV	#5, W0
	MOV	W0, _ebb_target_pos
;EBB_DPX.c,104 :: 		}
L_timer1_interrupt144:
;EBB_DPX.c,105 :: 		if (timer1_counter == 550){
	MOV	_timer1_counter, W1
	MOV	#550, W0
	CP	W1, W0
...
;EBB_DPX.c,106 :: 		ebb_current_state = EBB_OFF;
	...
	CLR	W0
	MOV.B	W0, [W1]
;EBB_DPX.c,107 :: 		ebb_target_pos = 8;
	MOV	#8, W0
	MOV	W0, _ebb_target_pos
;EBB_DPX.c,108 :: 		timer1_counter = 0;
	CLR	W0
	MOV	W0, _timer1_counter
;EBB_DPX.c,109 :: 		}
L_timer1_interrupt145:
;EBB_DPX.c,112 :: 		if(ebb_current_state != OFF && brake_pressure_front >= BRAKE_PRESSURE_TRIGGER)
	MOV	#lo_addr(_ebb_current_state), W0
	MOV.B	[W0], W0
	CP.B	W0, #0
	BRA NZ	L__timer1_interrupt312
	GOTO	L__timer1_interrupt171
L__timer1_interrupt312:
	MOV	_brake_pressure_front, W1
	MOV	#1000, W0
	CP	W1, W0
	BRA GEU	L__timer1_interrupt313
	GOTO	L__timer1_interrupt170
L__timer1_interrupt313:
L__timer1_interrupt169:
;EBB_DPX.c,114 :: 		ENABLE = OFF;  //Turn off the motor
	BCLR	LATE2_bit, BitPos(LATE2_bit+0)
;EBB_DPX.c,115 :: 		ebb_current_state = EBB_DRIVER_BRAKING;  //Enter corresponding mode
	MOV	#lo_addr(_ebb_current_state), W1
	MOV.B	#7, W0
	MOV.B	W0, [W1]
;EBB_DPX.c,112 :: 		if(ebb_current_state != OFF && brake_pressure_front >= BRAKE_PRESSURE_TRIGGER)
...
;EBB_DPX.c,120 :: 		onTimer2Interrupt {
;EBB_DPX.c,121 :: 		timer2_counter++;
	MOV	#1, W1
	MOV	#lo_addr(_timer2_counter), W0
	ADD	W1, [W0], [W0]
;EBB_DPX.c,122 :: 		EBB_control();
	CALL	_EBB_control
;EBB_DPX.c,123 :: 		if (timer2_counter >= 5)
	MOV	_timer2_counter, W0
	CP	W0, #5
	BRA GE	L__timer2_interrupt315
	GOTO	L_timer2_interrupt149
L__timer2_interrupt315:
;EBB_DPX.c,125 :: 		CAN_routine();  //Call the can update routine
	CALL	_CAN_routine
;EBB_DPX.c,126 :: 		timer2_counter = 0;
	CLR	W0
	MOV	W0, _timer2_counter
;EBB_DPX.c,127 :: 		}
L_timer2_interrupt149:
;EBB_DPX.c,128 :: 		clearTimer2();
	BCLR	IFS0bits, #6
;EBB_DPX.c,129 :: 		}
...
;EBB_DPX.c,131 :: 		onTimer4Interrupt {
;EBB_DPX.c,132 :: 		if(buzzer_state == ON){  //Sound routine
	MOV	_buzzer_state, W0
	CP	W0, #1
	BRA Z	L__timer4_interrupt317
	GOTO	L_timer4_interrupt150
L__timer4_interrupt317:
;EBB_DPX.c,133 :: 		BUZZER = !BUZZER;
	BTG	LATD2_bit, BitPos(LATD2_bit+0)
;EBB_DPX.c,134 :: 		}
L_timer4_interrupt150:
;EBB_DPX.c,135 :: 		clearTimer4();
	BCLR	IFS1bits, #5
;EBB_DPX.c,136 :: 		}
...
;EBB_DPX.c,139 :: 		void main() {
;EBB_DPX.c,140 :: 		EBB_Init();
	CALL	_EBB_Init
;EBB_DPX.c,141 :: 		while(1)
L_main151:
;EBB_DPX.c,143 :: 		}
	GOTO	L_main151
;EBB_DPX.c,145 :: 		}
...
;EBB_DPX.c,147 :: 		onCanInterrupt {
;EBB_DPX.c,153 :: 		Can_read(&CAN_id, CAN_datain, &CAN_dataLen, &CAN_flags);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	...
	MOV	W0, W10
	CALL	_Can_read
;EBB_DPX.c,155 :: 		if (CAN_dataLen >= 2) {
	MOV	[W14+12], W0
	CP	W0, #2
	BRA GEU	L__CAN_Interrupt321
	GOTO	L_CAN_Interrupt153
L__CAN_Interrupt321:
;EBB_DPX.c,156 :: 		firstInt = (unsigned int) ((CAN_datain[0] << 8) | (CAN_datain[1] & 0xFF));
	ADD	W14, #4, W1
	MOV.B	[W1], W0
	ZE	W0, W0
	SL	W0, #8, W2
...
;EBB_DPX.c,157 :: 		}
L_CAN_Interrupt153:
;EBB_DPX.c,158 :: 		if (CAN_dataLen >= 4) {
	MOV	[W14+12], W0
	CP	W0, #4
	BRA GEU	L__CAN_Interrupt322
	GOTO	L_CAN_Interrupt154
L__CAN_Interrupt322:
;EBB_DPX.c,159 :: 		secondInt = (unsigned int) ((CAN_datain[2] << 8) | (CAN_datain[3] & 0xFF));
	ADD	W14, #4, W1
	ADD	W1, #2, W0
	MOV.B	[W0], W0
	ZE	W0, W0
...
;EBB_DPX.c,160 :: 		}
L_CAN_Interrupt154:
;EBB_DPX.c,161 :: 		if (CAN_dataLen >= 6) {
	MOV	[W14+12], W0
	CP	W0, #6
	BRA GEU	L__CAN_Interrupt323
	GOTO	L_CAN_Interrupt155
L__CAN_Interrupt323:
;EBB_DPX.c,162 :: 		thirdInt = (unsigned int) ((CAN_datain[4] << 8) | (CAN_datain[5] & 0xFF));
	ADD	W14, #4, W1
	ADD	W1, #4, W0
	MOV.B	[W0], W0
	ZE	W0, W0
...
;EBB_DPX.c,163 :: 		}
L_CAN_Interrupt155:
;EBB_DPX.c,164 :: 		if (CAN_dataLen >= 8) {
	MOV	[W14+12], W0
	CP	W0, #8
...
;EBB_DPX.c,166 :: 		}
L_CAN_Interrupt156:
;EBB_DPX.c,167 :: 		Can_clearInterrupt();
	CALL	_Can_clearInterrupt
;EBB_DPX.c,169 :: 		switch(CAN_id){
	GOTO	L_CAN_Interrupt157
;EBB_DPX.c,170 :: 		case SW_BRAKE_BIAS_EBB_ID:
L_CAN_Interrupt159:
;EBB_DPX.c,171 :: 		ebb_target_pos = ((unsigned int)firstInt);
	MOV	[W14+16], W0
	MOV	W0, _ebb_target_pos
;EBB_DPX.c,172 :: 		ebb_settings = ((unsigned int)secondInt);
	MOV	[W14+18], W0
	MOV	W0, _ebb_settings
;EBB_DPX.c,173 :: 		if ((ebb_target_pos != ebb_current_pos) && ebb_target_pos >= MIN_POSITION && ebb_target_pos <= MAX_POSITION)
	MOV	[W14+16], W1
	MOV	#lo_addr(_ebb_current_pos), W0
	CP	W1, [W0]
	BRA NZ	L__CAN_Interrupt325
...
L__CAN_Interrupt326:
	MOV	_ebb_target_pos, W0
	CP	W0, #16
	BRA LEU	L__CAN_Interrupt327
	GOTO	L__CAN_Interrupt173
L__CAN_Interrupt327:
L__CAN_Interrupt172:
;EBB_DPX.c,175 :: 		is_requested_movement = ON;
	MOV	#lo_addr(_is_requested_movement), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;EBB_DPX.c,176 :: 		}else if (ebb_target_pos == CALIBRATION_POSITION)
...
;EBB_DPX.c,176 :: 		}else if (ebb_target_pos == CALIBRATION_POSITION)
	...
	CP	W1, [W0]
	BRA Z	L__CAN_Interrupt328
	GOTO	L_CAN_Interrupt164
L__CAN_Interrupt328:
;EBB_DPX.c,178 :: 		is_requested_calibration = ON;
	MOV	#lo_addr(_is_requested_calibration), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;EBB_DPX.c,179 :: 		}
...
;EBB_DPX.c,181 :: 		case DAU_FR_ID:
L_CAN_Interrupt165:
;EBB_DPX.c,182 :: 		brake_pressure_front = ((unsigned int)thirdInt);
	MOV	[W14+20], W0
	MOV	W0, _brake_pressure_front
;EBB_DPX.c,183 :: 		break;
	GOTO	L_CAN_Interrupt158
